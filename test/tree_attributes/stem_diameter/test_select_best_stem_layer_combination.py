...
class TestSelectBestStemLayerCombination:
    ...
    def test_too_few_existing_layers(self):
        ...
        selected_combination = select_best_stem_layer_combination(existing_layers, diameters, 3, max_std_diameter=1.0)
    ...
    def test_selects_combination_with_lowest_diameter_std(self):
        ...
        selected_combination = select_best_stem_layer_combination(existing_layers, diameters, 3, max_std_diameter=10.0)
    ...
    def test_no_combination_below_max_std_diameter(self):
        ...
        selected_combination = select_best_stem_layer_combination(existing_layers, diameters, 2, max_std_diameter=0.01)
    ...
    def test_filters_by_max_std_position(self):
        ...
        combination = select_best_stem_layer_combination(
    ...
    def test_no_combination_below_max_std_position(self):
        ...
        selected_combination = select_best_stem_layer_combination(
